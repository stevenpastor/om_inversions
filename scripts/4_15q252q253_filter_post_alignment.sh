...
#SBATCH --output=inv15q252q253_%A-%a.out    
#SBATCH --error=inv15q252q253_%A-%a.err  
...
CHR="chr15"
# ref:
REF="81400000_86200000"
# SD groups surrounding (including) inversion:
FIVEFIVESD=2654815
FIVETHREESD=3167857
THREEFIVESD=3759601
THREETHREESD=3855818
...
SPLIT_DIRECTORY="/mnt/isilon/emanuel_lab/bionano_assemblies_BACKUP/Compressed_Assemblies/DLE1_Assemblies/all_assemblies/FINAL_APPROACH_INVERSIONS/15q252q253_mapped"
...
#for i in *_q.cmap; do grep "#" $i; done > "$SAMPLE"_"$REF"_q.cmap
...
#for i in *_r.cmap; do cp -f $i "$SAMPLE"_"$REF"_r.cmap; done
#
## merge xmaps:
##grep "#" "$SAMPLE"_1_vs_"$CHR"_"$REF".xmap > "$SAMPLE"_"$REF".xmap
#for i in *.xmap; do grep "#" $i; done > "$SAMPLE"_"$REF".xmap
