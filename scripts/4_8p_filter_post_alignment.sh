...
#SBATCH --output=inv8_%A-%a.out    
#SBATCH --error=inv8_%A-%a.err  
...
SPLIT_DIRECTORY="/mnt/isilon/emanuel_lab/bionano_assemblies_BACKUP/Compressed_Assemblies/DLE1_Assemblies/all_assemblies/FINAL_APPROACH_INVERSIONS/8p_mapped"
