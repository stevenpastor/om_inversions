...
#SBATCH --output=inv15q252_%A-%a.out    
#SBATCH --error=inv15q252_%A-%a.err  
...
SPLIT_DIRECTORY="/mnt/isilon/emanuel_lab/bionano_assemblies_BACKUP/Compressed_Assemblies/DLE1_Assemblies/all_assemblies/FINAL_APPROACH_INVERSIONS/15q252_mapped"
