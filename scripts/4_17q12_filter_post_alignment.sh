...
#SBATCH --output=inv1712_%A-%a.out    
#SBATCH --error=inv1712_%A-%a.err  
...
CHR="chr17"
# ref:
REF="35700000_38700000"
# SD groups surrounding (including) inversion:
FIVEFIVESD=529133
FIVETHREESD=708659
THREEFIVESD=2217051
THREETHREESD=2631914
...
SPLIT_DIRECTORY="/mnt/isilon/emanuel_lab/bionano_assemblies_BACKUP/Compressed_Assemblies/DLE1_Assemblies/all_assemblies/FINAL_APPROACH_INVERSIONS/17q_12_mapped"
