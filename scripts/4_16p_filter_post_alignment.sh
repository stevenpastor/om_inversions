...
#SBATCH --output=invfilt16_%A-%a.out    
#SBATCH --error=invfilt16_%A-%a.err  
...
CHR="chr16"
# ref:
REF="20900000_23400000"
# SD groups surrounding (including) inversion:
FIVEFIVESD=829754
FIVETHREESD=1056845
THREEFIVESD=1525840
THREETHREESD=1819324
...
SPLIT_DIRECTORY="/mnt/isilon/emanuel_lab/bionano_assemblies_BACKUP/Compressed_Assemblies/DLE1_Assemblies/all_assemblies/FINAL_APPROACH_INVERSIONS/16p_mapped"
